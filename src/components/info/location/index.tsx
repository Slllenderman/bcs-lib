        ...
        <ThemeProvider theme={theme}>
            <Container variant="accent">
                <Box display="flex" flexDirection="row" alignItems="center" width={1}>
                    <Box display="flex" flexDirection="column" marginLeft="8%" width="40%">
                        <Typography variant="subtitle1" noWrap={true} marginBottom="10%" fontK={props.font_size}>
                            Место проведения
                        </Typography>
                        <Typography variant="h2" marginBottom="10%" fontK={props.font_size}>
                            { props.address }
                        </Typography>
                        <Box width="80%">
                    ...
                    <Box width="50%" height="100%" marginLeft="auto">
